...
@section('title') Pictures | FindMeHome @endsection
                        ...
                        <div class="col-md-12 wiz-content">
                            ...
                            <div class="form-group clearfix">
                                <div class="col-sm-12 padding-left-0 padding-right-0">
                                    <form action="{{ route('property.new-listing-photos-upload', $property->id) }}"
                                          class="dropzone"
                                          id="real-dropzone">
                                        {{ csrf_field() }}
                                        ...
                                        <h4 style="text-align: center;color:#428bca;">Drop images in this area  <span class="glyphicon glyphicon-hand-down"></span> or Click to upload </h4>
                                        <h5 style="text-align: center;">Maximum file size: 5 MB</h5>
